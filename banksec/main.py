...
|____/ \__,_|_| |_|_|\_\|____/ \___|\___|
  ...
  Banking & ATM Security Audit Framework v1.0
...
def parse_args():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python main.py --target bank.example.com
  python main.py --target 192.168.1.100 --mode atm
  python main.py --target bank.example.com --mode web --format html
  python main.py --target 10.0.0.1 --mode network --port-range 1-10000
  python main.py --target bank.example.com --mode full --format all --output /tmp/report
        """
    )
