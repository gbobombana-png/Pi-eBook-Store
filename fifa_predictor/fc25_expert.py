...
ALL_MATCHES = [
    ...
    ("Bayern Munich",4,"Barcelona",5),
    ("Juventus",4,"Inter Miami",3),
    ("Liverpool",3,"Man City",4),
    ("Barcelona",4,"Arsenal",1),
    ("Inter Miami",3,"Juventus",1),
    ("PSG",5,"Inter Miami",3),
    # #N161–#N167
    ("Barcelona",1,"Al Nassr",2),
    ("PSG",0,"Inter Miami",3),
    ("PSG",10,"Inter Miami",9),
    ("Juventus",5,"PSG",3),
    ...
    ("Inter Miami",3,"Barcelona",4),
    ("Barcelona",4,"Arsenal",3),
    ("Juventus",3,"PSG",4),
    ("PSG",5,"Juventus",4),
    ("Inter Miami",5,"Barcelona",4),
    ("Juventus",2,"Inter Miami",4),
    ("PSG",2,"Inter Miami",3),
